...
class PurchaseInvoice(BuyingController):
    ...
    def before_save(self):
        ...
        if len(self.customer_loan_deduction) > 0:
            ...
            if self.customer_loan_deduction[0].total_recieveable > self.customer_loan_deduction[0].total_payable:
            ...
            self.customer_loan_deduction[0].net_payable = self.customer_loan_deduction[0].total_payable - self.customer_loan_deduction[0].allocated_amount
            self.customer_loan_deduction[0].net_recieveable = self.customer_loan_deduction[0].total_recieveable - self.customer_loan_deduction[0].allocated_amount
