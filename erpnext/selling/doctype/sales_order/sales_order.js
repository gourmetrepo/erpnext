		...
		if (doc.docstatus==1) {
			...
			if(this.frm.has_perm("submit")) {
				if(doc.status === 'On Hold') {
			   	...
			   	else if(doc.status === 'Closed' && (!['Unit 5', 'Unit 8','Unit 11'].includes(doc.company) || frappe.session.user_email=='national.ssam@gourmetpakistan.com'|| frappe.session.user_email=='ali.razaa@gourmetpakistan.com'|| frappe.session.user_email=='asif.iqbal@gourmetpakistan.com' || frappe.session.user_email=='m.farhan1@gourmetpakistan.com')) {
				   // un-close
