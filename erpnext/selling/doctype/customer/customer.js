...
frappe.ui.form.on('Customer Bank Guarantee', {
	form_render(frm, cdt, cdn){
        ...
        frm.fields_dict.bank_guarantee.grid.wrapper.find('.grid-duplicate-row').hide();
        frm.fields_dict.bank_guarantee.grid.wrapper.find('.grid-move-row').hide();
        frm.fields_dict.bank_guarantee.grid.wrapper.find('.grid-append-row').hide();
        frm.fields_dict.bank_guarantee.grid.wrapper.find('.grid-insert-row-below').hide();
        frm.fields_dict.bank_guarantee.grid.wrapper.find('.grid-insert-row').hide();
	}
});
