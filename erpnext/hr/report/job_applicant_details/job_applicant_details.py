...
def get_columns():
	return [
		...
		{"label": "Mobile", "fieldname": "mobile", "fieldtype": "Data", "width": 100},
		{"label": "Email", "fieldname": "email", "fieldtype": "Data", "width": 200},
		{"label": "Job Opening", "fieldname": "job_opening", "fieldtype": "Link", "options": "Job Opening", "width": 110},
		{"label": "Work Experience", "fieldname": "experience", "fieldtype": "Float", "width": 125},
		{"label": "Job Title", "fieldname": "job_title", "fieldtype": "Data", "width": 150},
		{"label": "Company", "fieldname": "company", "fieldtype": "Link", "options": "Company", "width": 110},
		{"label": "Start Date", "fieldname": "start_date", "fieldtype": "Date", "width": 95},
		{"label": "End Date", "fieldname": "end_date", "fieldtype": "Date", "width": 95},
		{"label": "Last Drawn Salary", "fieldname": "last_drawn_salary", "fieldtype": "Currency", "width": 130},
		{"label": "Perks & Benifits", "fieldname": "perks_and_benefits", "fieldtype": "Data", "width": 180},
		{"label": "Reason For Job Switch", "fieldname": "reason_for_leaving", "fieldtype": "Data", "width": 160},
		{"label": "Notice Period", "fieldname": "notice_period", "fieldtype": "Int", "width": 110},
		{"label": "Education Title", "fieldname": "education_title", "fieldtype": "Data", "width": 125},
		{"label": "Specialization", "fieldname": "specialization", "fieldtype": "Data", "width": 110},
		...
		{"label": "Marital Status", "fieldname": "marital_status", "fieldtype": "Data", "width": 110},
		{"label": "Permanent City", "fieldname": "permanent_city", "fieldtype": "Data", "width": 120},
		{"label": "Residing City", "fieldname": "residing_city", "fieldtype": "Data", "width": 120},
		{"label": "Open to Relocate", "fieldname": "open_to_relocate", "fieldtype": "Check", "width": 130}
	]
