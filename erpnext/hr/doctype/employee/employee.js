...
frappe.ui.form.on('Employee',{
	...
	onload:function(frm) {
        ...
        cur_frm.fields_dict['employee_address'].grid.get_field('province').get_query = function(doc,dt, dn) {
        ...
        cur_frm.fields_dict['employee_address'].grid.get_field('city').get_query = function(doc,dt, dn) {
